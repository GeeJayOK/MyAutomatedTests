Feature: Testing of Password Recovery page2
  ...
  Scenario: 05.0017 Check that 'Password2' field is not accept invalid data (same as login)
    Given User goes to the "https://192.168.217.23/index.html#/recovery" page
    When Password recovery page1 is opened
    Then User enter data "ya.getalo@aimprosoft.com" in the 'Email' field
    And User clicks on the 'Submit' button
  ...
  Scenario: 05.0018 Check that 'Password1' field is not accept invalid data (same as login)
    Given User goes to the "https://192.168.217.23/index.html#/recovery" page
    When Password recovery page1 is opened
    Then User enter data "ya.getalo@aimprosoft.com" in the 'Email' field
    And User clicks on the 'Submit' button
  ...
  Scenario: 05.0019 Check that 'Password2' field is not accept invalid data (same as login)
    Given User goes to the "https://192.168.217.23/index.html#/recovery" page
    When Password recovery page1 is opened
    Then User enter data "ya.getalo@aimprosoft.com" in the 'Email' field
    And User clicks on the 'Submit' button
  ...
  Scenario: 05.0020 Check that comparison with 'Password'/'Password2' fields is work.
    Given User goes to the "https://192.168.217.23/index.html#/recovery" page
    When Password recovery page1 is opened
    Then User enter data "ya.getalo@aimprosoft.com" in the 'Email' field
    And User clicks on the 'Submit' button
